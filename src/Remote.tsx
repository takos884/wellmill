      ...
      <div className={styles.content}>
          ...
          <div className={styles.colorBox} style={{backgroundColor: "#f9f0f7"}}>
            <div className={styles.colorContent}>
                ...
                <img className={styles.colorImg} src="/remote-1.png" />
            </div>
          </div>
          ...
          <div className={styles.colorBox} style={{backgroundColor: "#fdf2d8"}}>
            <div className={styles.colorContent}>
                ...
                <img className={styles.colorImg} src="/remote-2.png" />
            </div>
          </div>
          ...
          <div className={styles.colorBox} style={{backgroundColor: "#f9f0f7"}}>
            <div className={styles.colorContent}>
                ...
                <img className={styles.colorImg} src="/remote-3.png" />
            </div>
          </div>
          ...
          <div className={styles.colorBox} style={{backgroundColor: "#fcc24c"}}>
            <div className={styles.bubbleWrapper}>
              ...
              <div className={styles.bubble}>
                ...
                <img className={styles.bubbleImg} src="/remote-foot-1.png"/>
              </div>
              ...
              <div className={styles.bubble} style={{alignSelf: "flex-end"}}>
                ...
                <img className={styles.bubbleImg} src="/remote-foot-2.png"/>
              </div>
              ...
              <div className={styles.bubble}>
                ...
                <img className={styles.bubbleImg} src="/remote-foot-3.png"/>
              </div>
              ...
              <div className={styles.bubble} style={{alignSelf: "flex-end"}}>
                ...
                <img className={styles.bubbleImg} src="/remote-foot-4.png"/>
              </div>
              ...
              <div className={styles.bubble}>
                ...
                <img className={styles.bubbleImg} src="/remote-foot-5.png"/>
              </div>
